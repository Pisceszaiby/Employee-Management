...
function EmployeeList() {
    ...
    const handleDelete = async (employeeUniq) => {
        const url = `http://localhost:4000/employees/${employeeUniq}`;
                    ...
                    <div className="card" key={employee.id}>
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-lg-6 col-md-6">
                                    <button className="btn delete" type='submit' onClick={() => handleDelete(employee.phone)}>
